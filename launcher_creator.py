...
def main():
    ...
    parser.add_argument('-e', action='store', dest='email', default='moldach@ucalgary.ca', help='Your email address if you want to receive an email from Lonestar when your job starts and ends. Default=OFF')
    ...
    parser.add_argument('-a', action='store', dest='allocation', default='mega2014', help='The TACC allocation for job submission. Default="20120521SSINGS"')
